...
Debido a que los comandos os.fork() son del kernel de linux, el codigo no s epodia ejecutar en Windows sin que saltase un error, para resolverlo, se tuvo que instalar Windows Subsystem for Linux con Ubuntu para tener asi un entorno de ejecucion que si permitiera correr el programa.
